...
void setupAnalogInput(){
    ...
    // Автоматический рассчет аналогового преобразования без запроса
    //ADCSRA |= (1<<ADFR); // Включаем аналоговый вход
...
void loop(){
    ...
    //ADCSRA &= ~(1<<ADSC); // Сбрасываем вручную если был активен рассчет
    ADCSRA |= (1<<ADSC);
